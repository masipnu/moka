...
-- Dumping data for table moka.komli: ~2 rows (approximately)
DELETE FROM `komli`;
...
-- Dumping data for table moka.mapel: ~18 rows (approximately)
DELETE FROM `mapel`;
...
-- Dumping data for table moka.mengajar: ~0 rows (approximately)
...
INSERT INTO `ortu` (`id_ortu`, `nama`, `jk`, `alamat`, `ttl`, `status`, `no_hp`, `id_siswa`, `id_role`, `username`, `password`) VALUES
	('ORT0001', 'Linda Tri Wulandari', 'P', NULL, NULL, NULL, '625882196287', 'PD0054', 4, 'lin', '9ee522bab17b185bdc90f132fe77e1da');
...
CREATE TABLE `view_mengajar` (
	`id_mengajar` INT(11) NULL,
	`id_guru` VARCHAR(10) NOT NULL COLLATE 'latin1_swedish_ci',
	`nama` VARCHAR(50) NOT NULL COLLATE 'latin1_swedish_ci',
	`nama_mapel` VARCHAR(50) NULL COLLATE 'latin1_swedish_ci',
	`nama_kelas` VARCHAR(3) NULL COLLATE 'latin1_swedish_ci',
	`nama_komli` VARCHAR(50) NULL COLLATE 'latin1_swedish_ci'
) ENGINE=MyISAM;
