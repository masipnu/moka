...
-- Dumping data for table moka.jadwal_kbm: ~2 rows (approximately)
...
INSERT INTO `log_presensi` (`id_log`, `tgl`, `id_mengajar`, `id_siswa`, `id_presensi`, `catatan`) VALUES
	(1, '2023-01-17', 6, 'PD0001', 1, NULL),
	(2, '2023-01-17', 7, 'PD0072', 1, NULL);
...
-- Dumping data for table moka.mapel: ~19 rows (approximately)
/*!40000 ALTER TABLE `mapel` DISABLE KEYS */;
INSERT INTO `mapel` (`id_mapel`, `nama_mapel`, `id_kelas`) VALUES
	(2, 'Basis Data', 13),
	(3, 'Basis Data', 15),
	(4, 'Pendidikan Agama Islam', 11),
	(5, 'Pendidikan Agama Islam', 12),
	(6, 'Pendidikan Agama Islam', 13),
	(7, 'Pendidikan Agama Islam', 14),
	(8, 'Pendidikan Agama Islam', 15),
	(9, 'Pendidikan Agama Islam', 16),
	(10, 'Kelas Samsung', 11),
	(11, 'Kelas Samsung', 13),
	(12, 'Kelas Samsung', 15),
	(13, 'Bahasa Indonesia', 11),
	(14, 'Bahasa Indonesia', 12),
	(15, 'Bahasa Indonesia', 13),
	(16, 'Bahasa Indonesia', 14),
	(17, 'Bahasa Indonesia', 15),
	(18, 'Bahasa Indonesia', 15),
	(19, 'Dasar Desain Grafis', 11),
	(21, 'Aswaja', 11);
...
-- Dumping data for table moka.mengajar: ~2 rows (approximately)
...
CREATE  VIEW `pop_xii_pbs` AS SELECT COUNT(id_kelas) FROM siswa WHERE id_kelas=16 ;

-- Dumping structure for view moka.pop_xii_rpl
-- Removing temporary table and create final VIEW structure
DROP TABLE IF EXISTS `pop_xii_rpl`;
CREATE  VIEW `pop_xii_rpl` AS SELECT COUNT(id_kelas) FROM siswa WHERE id_kelas=15 ;

-- Dumping structure for view moka.pop_xi_pbs
-- Removing temporary table and create final VIEW structure
DROP TABLE IF EXISTS `pop_xi_pbs`;
CREATE  VIEW `pop_xi_pbs` AS SELECT COUNT(id_kelas) FROM siswa WHERE id_kelas=14 ;

-- Dumping structure for view moka.pop_xi_rpl
-- Removing temporary table and create final VIEW structure
DROP TABLE IF EXISTS `pop_xi_rpl`;
CREATE  VIEW `pop_xi_rpl` AS SELECT COUNT(id_kelas) FROM siswa WHERE id_kelas=13 ;

-- Dumping structure for view moka.pop_x_pbs
-- Removing temporary table and create final VIEW structure
DROP TABLE IF EXISTS `pop_x_pbs`;
CREATE  VIEW `pop_x_pbs` AS SELECT COUNT(id_kelas) FROM siswa WHERE id_kelas=12 ;

-- Dumping structure for view moka.pop_x_rpl
-- Removing temporary table and create final VIEW structure
DROP TABLE IF EXISTS `pop_x_rpl`;
CREATE  VIEW `pop_x_rpl` AS SELECT COUNT(id_kelas) FROM siswa WHERE id_kelas=11 ;

-- Dumping structure for view moka.view_guru_all
-- Removing temporary table and create final VIEW structure
DROP TABLE IF EXISTS `view_guru_all`;
CREATE  VIEW `view_guru_all` AS select 
id_guru,
nama,
gelar,
jk,
...
CREATE  VIEW `view_jadwal_all` AS select
jadwal_kbm.id_kbm,
hari.nama_hari,
jamke.nama_jamke,
kelas.nama_kelas,
...
CREATE  VIEW `view_jadwal_xii_pbs_1` AS select
jadwal_kbm.id_kbm,
hari.nama_hari,
jamke.nama_jamke,
mapel.nama_mapel,
...
CREATE  VIEW `view_jadwal_xii_pbs_2` AS select
jadwal_kbm.id_kbm,
hari.nama_hari,
jamke.nama_jamke,
mapel.nama_mapel,
...
CREATE  VIEW `view_jadwal_xii_pbs_3` AS select
jadwal_kbm.id_kbm,
hari.nama_hari,
jamke.nama_jamke,
mapel.nama_mapel,
...
CREATE  VIEW `view_jadwal_xii_pbs_4` AS select
jadwal_kbm.id_kbm,
hari.nama_hari,
jamke.nama_jamke,
mapel.nama_mapel,
...
CREATE  VIEW `view_jadwal_xii_pbs_5` AS select
jadwal_kbm.id_kbm,
hari.nama_hari,
jamke.nama_jamke,
mapel.nama_mapel,
...
CREATE  VIEW `view_jadwal_xii_pbs_6` AS select
jadwal_kbm.id_kbm,
hari.nama_hari,
jamke.nama_jamke,
mapel.nama_mapel,
...
CREATE  VIEW `view_jadwal_xii_rpl_1` AS select
jadwal_kbm.id_kbm,
hari.nama_hari,
jamke.nama_jamke,
mapel.nama_mapel,
...
CREATE  VIEW `view_jadwal_xii_rpl_2` AS select
jadwal_kbm.id_kbm,
hari.nama_hari,
jamke.nama_jamke,
mapel.nama_mapel,
...
CREATE  VIEW `view_jadwal_xii_rpl_3` AS select
jadwal_kbm.id_kbm,
hari.nama_hari,
jamke.nama_jamke,
mapel.nama_mapel,
...
CREATE  VIEW `view_jadwal_xii_rpl_4` AS select
jadwal_kbm.id_kbm,
hari.nama_hari,
jamke.nama_jamke,
mapel.nama_mapel,
...
CREATE  VIEW `view_jadwal_xii_rpl_5` AS select
jadwal_kbm.id_kbm,
hari.nama_hari,
jamke.nama_jamke,
mapel.nama_mapel,
...
CREATE  VIEW `view_jadwal_xii_rpl_6` AS select
jadwal_kbm.id_kbm,
hari.nama_hari,
jamke.nama_jamke,
mapel.nama_mapel,
...
CREATE  VIEW `view_jadwal_xi_pbs_1` AS select
jadwal_kbm.id_kbm,
hari.nama_hari,
jamke.nama_jamke,
mapel.nama_mapel,
...
CREATE  VIEW `view_jadwal_xi_pbs_2` AS select
jadwal_kbm.id_kbm,
hari.nama_hari,
jamke.nama_jamke,
mapel.nama_mapel,
...
CREATE  VIEW `view_jadwal_xi_pbs_3` AS select
jadwal_kbm.id_kbm,
hari.nama_hari,
jamke.nama_jamke,
mapel.nama_mapel,
...
CREATE  VIEW `view_jadwal_xi_pbs_4` AS select
jadwal_kbm.id_kbm,
hari.nama_hari,
jamke.nama_jamke,
mapel.nama_mapel,
...
CREATE  VIEW `view_jadwal_xi_pbs_5` AS select
jadwal_kbm.id_kbm,
hari.nama_hari,
jamke.nama_jamke,
mapel.nama_mapel,
...
CREATE  VIEW `view_jadwal_xi_pbs_6` AS select
jadwal_kbm.id_kbm,
hari.nama_hari,
jamke.nama_jamke,
mapel.nama_mapel,
...
CREATE  VIEW `view_jadwal_xi_rpl_1` AS select
jadwal_kbm.id_kbm,
hari.nama_hari,
jamke.nama_jamke,
mapel.nama_mapel,
...
CREATE  VIEW `view_jadwal_xi_rpl_2` AS select
jadwal_kbm.id_kbm,
hari.nama_hari,
jamke.nama_jamke,
mapel.nama_mapel,
...
CREATE  VIEW `view_jadwal_xi_rpl_3` AS select
jadwal_kbm.id_kbm,
hari.nama_hari,
jamke.nama_jamke,
mapel.nama_mapel,
...
CREATE  VIEW `view_jadwal_xi_rpl_4` AS select
jadwal_kbm.id_kbm,
hari.nama_hari,
jamke.nama_jamke,
mapel.nama_mapel,
...
CREATE  VIEW `view_jadwal_xi_rpl_5` AS select
jadwal_kbm.id_kbm,
hari.nama_hari,
jamke.nama_jamke,
mapel.nama_mapel,
...
CREATE  VIEW `view_jadwal_xi_rpl_6` AS select
jadwal_kbm.id_kbm,
hari.nama_hari,
jamke.nama_jamke,
mapel.nama_mapel,
...
CREATE  VIEW `view_jadwal_x_pbs_1` AS select
jadwal_kbm.id_kbm,
hari.nama_hari,
jamke.nama_jamke,
mapel.nama_mapel,
...
CREATE  VIEW `view_jadwal_x_pbs_2` AS select
jadwal_kbm.id_kbm,
hari.nama_hari,
jamke.nama_jamke,
mapel.nama_mapel,
...
CREATE  VIEW `view_jadwal_x_pbs_3` AS select
jadwal_kbm.id_kbm,
hari.nama_hari,
jamke.nama_jamke,
mapel.nama_mapel,
...
CREATE  VIEW `view_jadwal_x_pbs_4` AS select
jadwal_kbm.id_kbm,
hari.nama_hari,
jamke.nama_jamke,
mapel.nama_mapel,
...
CREATE  VIEW `view_jadwal_x_pbs_5` AS select
jadwal_kbm.id_kbm,
hari.nama_hari,
jamke.nama_jamke,
mapel.nama_mapel,
...
CREATE  VIEW `view_jadwal_x_pbs_6` AS select
jadwal_kbm.id_kbm,
hari.nama_hari,
jamke.nama_jamke,
mapel.nama_mapel,
...
CREATE  VIEW `view_jadwal_x_rpl_1` AS select
jadwal_kbm.id_kbm,
hari.nama_hari,
jamke.nama_jamke,
mapel.nama_mapel,
...
CREATE  VIEW `view_jadwal_x_rpl_2` AS select
jadwal_kbm.id_kbm,
hari.nama_hari,
jamke.nama_jamke,
mapel.nama_mapel,
...
CREATE  VIEW `view_jadwal_x_rpl_3` AS select
jadwal_kbm.id_kbm,
hari.nama_hari,
jamke.nama_jamke,
mapel.nama_mapel,
...
CREATE  VIEW `view_jadwal_x_rpl_4` AS select
jadwal_kbm.id_kbm,
hari.nama_hari,
jamke.nama_jamke,
mapel.nama_mapel,
...
CREATE  VIEW `view_jadwal_x_rpl_5` AS select
jadwal_kbm.id_kbm,
hari.nama_hari,
jamke.nama_jamke,
mapel.nama_mapel,
...
CREATE  VIEW `view_jadwal_x_rpl_6` AS select
jadwal_kbm.id_kbm,
hari.nama_hari,
jamke.nama_jamke,
mapel.nama_mapel,
...
CREATE  VIEW `view_jam_kbm` AS SELECT jam_kbm.id_kbm,hari.nama_hari,jamke.nama_jamke FROM jam_kbm
...
CREATE  VIEW `view_kelas` AS SELECT 
kelas.id_kelas,
kelas.nama_kelas,
komli.nama_komli,
komli.prosentase
...
CREATE  VIEW `view_log_presensi_all` AS select 
log_presensi.id_log,
log_presensi.tgl,
hari.nama_hari,
jamke.nama_jamke,
...
CREATE  VIEW `view_mengajar` AS select
...
CREATE  VIEW `view_ortu_all` AS select
ortu.id_ortu,
...
CREATE  VIEW `view_siswa_all` AS SELECT
siswa.id_siswa,
siswa.foto,
siswa.nis,
siswa.nama,
