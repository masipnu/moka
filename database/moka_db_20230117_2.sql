...
DROP VIEW IF EXISTS `pop_xii_pbs`;
...
DROP VIEW IF EXISTS `pop_xii_rpl`;
-- Creating temporary table to overcome VIEW dependency errors
...
DROP VIEW IF EXISTS `pop_xi_pbs`;
-- Creating temporary table to overcome VIEW dependency errors
...
DROP VIEW IF EXISTS `pop_xi_rpl`;
-- Creating temporary table to overcome VIEW dependency errors
...
DROP VIEW IF EXISTS `view_guru_all`;
-- Creating temporary table to overcome VIEW dependency errors
...
DROP VIEW IF EXISTS `view_jadwal_all`;
-- Creating temporary table to overcome VIEW dependency errors
...
DROP VIEW IF EXISTS `view_jadwal_xii_pbs_1`;
-- Creating temporary table to overcome VIEW dependency errors
...
DROP VIEW IF EXISTS `view_jadwal_xii_pbs_2`;
-- Creating temporary table to overcome VIEW dependency errors
...
DROP VIEW IF EXISTS `view_jadwal_xii_pbs_3`;
-- Creating temporary table to overcome VIEW dependency errors
...
DROP VIEW IF EXISTS `view_jadwal_xii_pbs_4`;
-- Creating temporary table to overcome VIEW dependency errors
...
DROP VIEW IF EXISTS `view_jadwal_xii_pbs_5`;
-- Creating temporary table to overcome VIEW dependency errors
...
DROP VIEW IF EXISTS `view_jadwal_xii_pbs_6`;
-- Creating temporary table to overcome VIEW dependency errors
...
DROP VIEW IF EXISTS `view_jadwal_xii_rpl_1`;
-- Creating temporary table to overcome VIEW dependency errors
...
DROP VIEW IF EXISTS `view_jadwal_xii_rpl_2`;
-- Creating temporary table to overcome VIEW dependency errors
...
DROP VIEW IF EXISTS `view_jadwal_xii_rpl_3`;
-- Creating temporary table to overcome VIEW dependency errors
...
DROP VIEW IF EXISTS `view_jadwal_xii_rpl_4`;
-- Creating temporary table to overcome VIEW dependency errors
...
DROP VIEW IF EXISTS `view_jadwal_xii_rpl_5`;
-- Creating temporary table to overcome VIEW dependency errors
...
DROP VIEW IF EXISTS `view_jadwal_xii_rpl_6`;
-- Creating temporary table to overcome VIEW dependency errors
...
DROP VIEW IF EXISTS `view_jadwal_xi_pbs_1`;
-- Creating temporary table to overcome VIEW dependency errors
...
DROP VIEW IF EXISTS `view_jadwal_xi_pbs_2`;
-- Creating temporary table to overcome VIEW dependency errors
...
DROP VIEW IF EXISTS `view_jadwal_xi_pbs_3`;
-- Creating temporary table to overcome VIEW dependency errors
...
DROP VIEW IF EXISTS `view_jadwal_xi_pbs_4`;
-- Creating temporary table to overcome VIEW dependency errors
...
DROP VIEW IF EXISTS `view_jadwal_xi_pbs_5`;
-- Creating temporary table to overcome VIEW dependency errors
...
DROP VIEW IF EXISTS `view_jadwal_xi_pbs_6`;
-- Creating temporary table to overcome VIEW dependency errors
...
DROP VIEW IF EXISTS `view_jadwal_xi_rpl_1`;
-- Creating temporary table to overcome VIEW dependency errors
...
DROP VIEW IF EXISTS `view_jadwal_xi_rpl_2`;
-- Creating temporary table to overcome VIEW dependency errors
...
DROP VIEW IF EXISTS `view_jadwal_xi_rpl_3`;
-- Creating temporary table to overcome VIEW dependency errors
...
DROP VIEW IF EXISTS `view_jadwal_xi_rpl_4`;
-- Creating temporary table to overcome VIEW dependency errors
...
DROP VIEW IF EXISTS `view_jadwal_xi_rpl_5`;
-- Creating temporary table to overcome VIEW dependency errors
...
DROP VIEW IF EXISTS `view_jadwal_xi_rpl_6`;
-- Creating temporary table to overcome VIEW dependency errors
...
DROP VIEW IF EXISTS `view_jadwal_x_pbs_1`;
-- Creating temporary table to overcome VIEW dependency errors
...
DROP VIEW IF EXISTS `view_jadwal_x_pbs_2`;
-- Creating temporary table to overcome VIEW dependency errors
...
DROP VIEW IF EXISTS `view_jadwal_x_pbs_3`;
-- Creating temporary table to overcome VIEW dependency errors
...
DROP VIEW IF EXISTS `view_jadwal_x_pbs_4`;
-- Creating temporary table to overcome VIEW dependency errors
...
DROP VIEW IF EXISTS `view_jadwal_x_pbs_5`;
-- Creating temporary table to overcome VIEW dependency errors
...
DROP VIEW IF EXISTS `view_jadwal_x_pbs_6`;
-- Creating temporary table to overcome VIEW dependency errors
...
DROP VIEW IF EXISTS `view_jadwal_x_rpl_1`;
-- Creating temporary table to overcome VIEW dependency errors
...
DROP VIEW IF EXISTS `view_jadwal_x_rpl_2`;
-- Creating temporary table to overcome VIEW dependency errors
...
DROP VIEW IF EXISTS `view_jadwal_x_rpl_3`;
-- Creating temporary table to overcome VIEW dependency errors
...
DROP VIEW IF EXISTS `view_jadwal_x_rpl_4`;
-- Creating temporary table to overcome VIEW dependency errors
...
DROP VIEW IF EXISTS `view_jadwal_x_rpl_5`;
-- Creating temporary table to overcome VIEW dependency errors
...
DROP VIEW IF EXISTS `view_jadwal_x_rpl_6`;
-- Creating temporary table to overcome VIEW dependency errors
...
DROP VIEW IF EXISTS `view_jam_kbm`;
-- Creating temporary table to overcome VIEW dependency errors
...
DROP VIEW IF EXISTS `view_log_presensi_all`;
-- Creating temporary table to overcome VIEW dependency errors
...
DROP VIEW IF EXISTS `view_mapel`;
-- Creating temporary table to overcome VIEW dependency errors
...
DROP VIEW IF EXISTS `view_mengajar`;
-- Creating temporary table to overcome VIEW dependency errors
...
DROP VIEW IF EXISTS `view_ortu_all`;
-- Creating temporary table to overcome VIEW dependency errors
...
DROP VIEW IF EXISTS `view_siswa_all`;
-- Creating temporary table to overcome VIEW dependency errors
