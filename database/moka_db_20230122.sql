...
-- Dumping data for table moka.jadwal_kbm: ~7 rows (approximately)
...
-- Dumping data for table moka.jam_kbm: ~49 rows (approximately)
...
-- Dumping data for table moka.log_presensi: ~28 rows (approximately)
/*!40000 ALTER TABLE `log_presensi` DISABLE KEYS */;
INSERT INTO `log_presensi` (`id_log`, `tgl`, `id_mengajar`, `id_siswa`, `id_presensi`, `catatan`) VALUES
	(1, '2023-01-21', 228, 'PD0002', 1, ''),
	(2, '2023-01-21', 228, 'PD0004', 1, ''),
	(3, '2023-01-21', 228, 'PD0008', 2, ''),
	(4, '2023-01-21', 228, 'PD0010', 2, ''),
	(5, '2023-01-21', 228, 'PD0011', 2, ''),
	(6, '2023-01-21', 228, 'PD0012', 3, ''),
	(7, '2023-01-21', 228, 'PD0017', 1, ''),
	(8, '2023-01-21', 228, 'PD0020', 1, ''),
	(9, '2023-01-21', 228, 'PD0025', 1, ''),
	(10, '2023-01-21', 228, 'PD0029', 1, ''),
	(11, '2023-01-21', 228, 'PD0033', 1, ''),
	(12, '2023-01-21', 228, 'PD0048', 1, ''),
	(13, '2023-01-21', 228, 'PD0049', 1, ''),
	(14, '2023-01-21', 228, 'PD0050', 1, ''),
	(15, '2023-01-21', 228, 'PD0057', 1, ''),
	(16, '2023-01-21', 228, 'PD0067', 2, ''),
	(17, '2023-01-21', 228, 'PD0069', 1, ''),
	(18, '2023-01-21', 228, 'PD0076', 1, ''),
	(19, '2023-01-21', 228, 'PD0078', 1, ''),
	(20, '2023-01-21', 228, 'PD0081', 1, ''),
	(21, '2023-01-21', 228, 'PD0089', 1, ''),
	(22, '2023-01-21', 228, 'PD0093', 1, ''),
	(23, '2023-01-21', 228, 'PD0097', 1, ''),
	(24, '2023-01-21', 228, 'PD0098', 1, ''),
	(25, '2023-01-21', 228, 'PD0101', 1, ''),
	(26, '2023-01-21', 228, 'PD0103', 1, ''),
	(27, '2023-01-21', 228, 'PD0105', 1, ''),
	(28, '2023-01-21', 228, 'PD0110', 4, 'waaduh');
...
-- Dumping data for table moka.mapel: ~87 rows (approximately)
...
-- Dumping data for table moka.mengajar: ~6 rows (approximately)
...
-- Dumping structure for view moka.view_id_mengajar_today
-- Creating temporary table to overcome VIEW dependency errors
CREATE TABLE `view_id_mengajar_today` (
	`id_mengajar` INT(11) NOT NULL
) ENGINE=MyISAM;
...
-- Dumping structure for view moka.view_jadwal_xii_pbs_jumat
-- Creating temporary table to overcome VIEW dependency errors
CREATE TABLE `view_jadwal_xii_pbs_jumat` (
	`id_kbm` CHAR(5) NOT NULL COLLATE 'latin1_swedish_ci',
...
-- Dumping structure for view moka.view_jadwal_xii_pbs_kamis
-- Creating temporary table to overcome VIEW dependency errors
CREATE TABLE `view_jadwal_xii_pbs_kamis` (
	`id_kbm` CHAR(5) NOT NULL COLLATE 'latin1_swedish_ci',
	`id_jadwal` INT(11) NOT NULL,
	`nama_hari` VARCHAR(50) NOT NULL COLLATE 'latin1_swedish_ci',
	`nama_jamke` INT(11) NOT NULL,
...
-- Dumping structure for view moka.view_jadwal_xii_pbs_rabu
-- Creating temporary table to overcome VIEW dependency errors
CREATE TABLE `view_jadwal_xii_pbs_rabu` (
	`id_kbm` CHAR(5) NOT NULL COLLATE 'latin1_swedish_ci',
	`id_jadwal` INT(11) NOT NULL,
	`nama_hari` VARCHAR(50) NOT NULL COLLATE 'latin1_swedish_ci',
	`nama_jamke` INT(11) NOT NULL,
...
-- Dumping structure for view moka.view_jadwal_xii_pbs_sabtu
-- Creating temporary table to overcome VIEW dependency errors
CREATE TABLE `view_jadwal_xii_pbs_sabtu` (
	`id_kbm` CHAR(5) NOT NULL COLLATE 'latin1_swedish_ci',
	`id_jadwal` INT(11) NOT NULL,
	`nama_hari` VARCHAR(50) NOT NULL COLLATE 'latin1_swedish_ci',
	`nama_jamke` INT(11) NOT NULL,
...
-- Dumping structure for view moka.view_jadwal_xii_pbs_selasa
-- Creating temporary table to overcome VIEW dependency errors
CREATE TABLE `view_jadwal_xii_pbs_selasa` (
	`id_kbm` CHAR(5) NOT NULL COLLATE 'latin1_swedish_ci',
	`id_jadwal` INT(11) NOT NULL,
	`nama_hari` VARCHAR(50) NOT NULL COLLATE 'latin1_swedish_ci',
	`nama_jamke` INT(11) NOT NULL,
...
-- Dumping structure for view moka.view_jadwal_xii_pbs_senin
-- Creating temporary table to overcome VIEW dependency errors
CREATE TABLE `view_jadwal_xii_pbs_senin` (
	`id_kbm` CHAR(5) NOT NULL COLLATE 'latin1_swedish_ci',
	`id_jadwal` INT(11) NOT NULL,
	`nama_hari` VARCHAR(50) NOT NULL COLLATE 'latin1_swedish_ci',
	`nama_jamke` INT(11) NOT NULL,
...
-- Dumping structure for view moka.view_jadwal_xii_rpl_jumat
-- Creating temporary table to overcome VIEW dependency errors
CREATE TABLE `view_jadwal_xii_rpl_jumat` (
	`id_kbm` CHAR(5) NOT NULL COLLATE 'latin1_swedish_ci',
	`id_jadwal` INT(11) NOT NULL,
	`nama_hari` VARCHAR(50) NOT NULL COLLATE 'latin1_swedish_ci',
	`nama_jamke` INT(11) NOT NULL,
...
-- Dumping structure for view moka.view_jadwal_xii_rpl_kamis
-- Creating temporary table to overcome VIEW dependency errors
CREATE TABLE `view_jadwal_xii_rpl_kamis` (
	`id_kbm` CHAR(5) NOT NULL COLLATE 'latin1_swedish_ci',
	`id_jadwal` INT(11) NOT NULL,
	`nama_hari` VARCHAR(50) NOT NULL COLLATE 'latin1_swedish_ci',
	`nama_jamke` INT(11) NOT NULL,
...
-- Dumping structure for view moka.view_jadwal_xii_rpl_rabu
-- Creating temporary table to overcome VIEW dependency errors
CREATE TABLE `view_jadwal_xii_rpl_rabu` (
	`id_kbm` CHAR(5) NOT NULL COLLATE 'latin1_swedish_ci',
	`id_jadwal` INT(11) NOT NULL,
	`nama_hari` VARCHAR(50) NOT NULL COLLATE 'latin1_swedish_ci',
	`nama_jamke` INT(11) NOT NULL,
...
-- Dumping structure for view moka.view_jadwal_xii_rpl_sabtu
-- Creating temporary table to overcome VIEW dependency errors
CREATE TABLE `view_jadwal_xii_rpl_sabtu` (
	`id_kbm` CHAR(5) NOT NULL COLLATE 'latin1_swedish_ci',
	`id_jadwal` INT(11) NOT NULL,
	`nama_hari` VARCHAR(50) NOT NULL COLLATE 'latin1_swedish_ci',
	`nama_jamke` INT(11) NOT NULL,
...
-- Dumping structure for view moka.view_jadwal_xii_rpl_selasa
-- Creating temporary table to overcome VIEW dependency errors
CREATE TABLE `view_jadwal_xii_rpl_selasa` (
	`id_kbm` CHAR(5) NOT NULL COLLATE 'latin1_swedish_ci',
	`id_jadwal` INT(11) NOT NULL,
	`nama_hari` VARCHAR(50) NOT NULL COLLATE 'latin1_swedish_ci',
	`nama_jamke` INT(11) NOT NULL,
...
-- Dumping structure for view moka.view_jadwal_xii_rpl_senin
-- Creating temporary table to overcome VIEW dependency errors
CREATE TABLE `view_jadwal_xii_rpl_senin` (
	`id_kbm` CHAR(5) NOT NULL COLLATE 'latin1_swedish_ci',
	`id_jadwal` INT(11) NOT NULL,
	`nama_hari` VARCHAR(50) NOT NULL COLLATE 'latin1_swedish_ci',
	`nama_jamke` INT(11) NOT NULL,
...
-- Dumping structure for view moka.view_jadwal_xi_pbs_jumat
-- Creating temporary table to overcome VIEW dependency errors
CREATE TABLE `view_jadwal_xi_pbs_jumat` (
	`id_kbm` CHAR(5) NOT NULL COLLATE 'latin1_swedish_ci',
	`id_jadwal` INT(11) NOT NULL,
	`nama_hari` VARCHAR(50) NOT NULL COLLATE 'latin1_swedish_ci',
	`nama_jamke` INT(11) NOT NULL,
...
-- Dumping structure for view moka.view_jadwal_xi_pbs_kamis
-- Creating temporary table to overcome VIEW dependency errors
CREATE TABLE `view_jadwal_xi_pbs_kamis` (
	`id_kbm` CHAR(5) NOT NULL COLLATE 'latin1_swedish_ci',
	`id_jadwal` INT(11) NOT NULL,
	`nama_hari` VARCHAR(50) NOT NULL COLLATE 'latin1_swedish_ci',
	`nama_jamke` INT(11) NOT NULL,
...
-- Dumping structure for view moka.view_jadwal_xi_pbs_rabu
-- Creating temporary table to overcome VIEW dependency errors
CREATE TABLE `view_jadwal_xi_pbs_rabu` (
	`id_kbm` CHAR(5) NOT NULL COLLATE 'latin1_swedish_ci',
	`id_jadwal` INT(11) NOT NULL,
	`nama_hari` VARCHAR(50) NOT NULL COLLATE 'latin1_swedish_ci',
	`nama_jamke` INT(11) NOT NULL,
...
-- Dumping structure for view moka.view_jadwal_xi_pbs_sabtu
-- Creating temporary table to overcome VIEW dependency errors
CREATE TABLE `view_jadwal_xi_pbs_sabtu` (
	`id_kbm` CHAR(5) NOT NULL COLLATE 'latin1_swedish_ci',
	`id_jadwal` INT(11) NOT NULL,
	`nama_hari` VARCHAR(50) NOT NULL COLLATE 'latin1_swedish_ci',
	`nama_jamke` INT(11) NOT NULL,
...
-- Dumping structure for view moka.view_jadwal_xi_pbs_selasa
-- Creating temporary table to overcome VIEW dependency errors
CREATE TABLE `view_jadwal_xi_pbs_selasa` (
	`id_kbm` CHAR(5) NOT NULL COLLATE 'latin1_swedish_ci',
	`id_jadwal` INT(11) NOT NULL,
	`nama_hari` VARCHAR(50) NOT NULL COLLATE 'latin1_swedish_ci',
	`nama_jamke` INT(11) NOT NULL,
...
-- Dumping structure for view moka.view_jadwal_xi_pbs_senin
-- Creating temporary table to overcome VIEW dependency errors
CREATE TABLE `view_jadwal_xi_pbs_senin` (
	`id_kbm` CHAR(5) NOT NULL COLLATE 'latin1_swedish_ci',
	`id_jadwal` INT(11) NOT NULL,
	`nama_hari` VARCHAR(50) NOT NULL COLLATE 'latin1_swedish_ci',
	`nama_jamke` INT(11) NOT NULL,
...
-- Dumping structure for view moka.view_jadwal_xi_rpl_jumat
-- Creating temporary table to overcome VIEW dependency errors
CREATE TABLE `view_jadwal_xi_rpl_jumat` (
	`id_kbm` CHAR(5) NOT NULL COLLATE 'latin1_swedish_ci',
	`id_jadwal` INT(11) NOT NULL,
	`nama_hari` VARCHAR(50) NOT NULL COLLATE 'latin1_swedish_ci',
	`nama_jamke` INT(11) NOT NULL,
...
-- Dumping structure for view moka.view_jadwal_xi_rpl_kamis
-- Creating temporary table to overcome VIEW dependency errors
CREATE TABLE `view_jadwal_xi_rpl_kamis` (
	`id_kbm` CHAR(5) NOT NULL COLLATE 'latin1_swedish_ci',
	`id_jadwal` INT(11) NOT NULL,
	`nama_hari` VARCHAR(50) NOT NULL COLLATE 'latin1_swedish_ci',
	`nama_jamke` INT(11) NOT NULL,
...
-- Dumping structure for view moka.view_jadwal_xi_rpl_rabu
-- Creating temporary table to overcome VIEW dependency errors
CREATE TABLE `view_jadwal_xi_rpl_rabu` (
	`id_kbm` CHAR(5) NOT NULL COLLATE 'latin1_swedish_ci',
	`id_jadwal` INT(11) NOT NULL,
	`nama_hari` VARCHAR(50) NOT NULL COLLATE 'latin1_swedish_ci',
	`nama_jamke` INT(11) NOT NULL,
...
-- Dumping structure for view moka.view_jadwal_xi_rpl_sabtu
-- Creating temporary table to overcome VIEW dependency errors
CREATE TABLE `view_jadwal_xi_rpl_sabtu` (
	`id_kbm` CHAR(5) NOT NULL COLLATE 'latin1_swedish_ci',
	`id_jadwal` INT(11) NOT NULL,
	`nama_hari` VARCHAR(50) NOT NULL COLLATE 'latin1_swedish_ci',
	`nama_jamke` INT(11) NOT NULL,
...
-- Dumping structure for view moka.view_jadwal_xi_rpl_selasa
-- Creating temporary table to overcome VIEW dependency errors
CREATE TABLE `view_jadwal_xi_rpl_selasa` (
	`id_kbm` CHAR(5) NOT NULL COLLATE 'latin1_swedish_ci',
	`id_jadwal` INT(11) NOT NULL,
	`nama_hari` VARCHAR(50) NOT NULL COLLATE 'latin1_swedish_ci',
	`nama_jamke` INT(11) NOT NULL,
...
-- Dumping structure for view moka.view_jadwal_xi_rpl_senin
-- Creating temporary table to overcome VIEW dependency errors
CREATE TABLE `view_jadwal_xi_rpl_senin` (
	`id_kbm` CHAR(5) NOT NULL COLLATE 'latin1_swedish_ci',
	`id_jadwal` INT(11) NOT NULL,
	`nama_hari` VARCHAR(50) NOT NULL COLLATE 'latin1_swedish_ci',
	`nama_jamke` INT(11) NOT NULL,
...
-- Dumping structure for view moka.view_jadwal_x_pbs_jumat
-- Creating temporary table to overcome VIEW dependency errors
CREATE TABLE `view_jadwal_x_pbs_jumat` (
	`id_kbm` CHAR(5) NOT NULL COLLATE 'latin1_swedish_ci',
	`id_jadwal` INT(11) NOT NULL,
	`nama_hari` VARCHAR(50) NOT NULL COLLATE 'latin1_swedish_ci',
	`nama_jamke` INT(11) NOT NULL,
...
-- Dumping structure for view moka.view_jadwal_x_pbs_kamis
-- Creating temporary table to overcome VIEW dependency errors
CREATE TABLE `view_jadwal_x_pbs_kamis` (
	`id_kbm` CHAR(5) NOT NULL COLLATE 'latin1_swedish_ci',
	`id_jadwal` INT(11) NOT NULL,
	`nama_hari` VARCHAR(50) NOT NULL COLLATE 'latin1_swedish_ci',
	`nama_jamke` INT(11) NOT NULL,
...
-- Dumping structure for view moka.view_jadwal_x_pbs_rabu
-- Creating temporary table to overcome VIEW dependency errors
CREATE TABLE `view_jadwal_x_pbs_rabu` (
	`id_kbm` CHAR(5) NOT NULL COLLATE 'latin1_swedish_ci',
	`id_jadwal` INT(11) NOT NULL,
	`nama_hari` VARCHAR(50) NOT NULL COLLATE 'latin1_swedish_ci',
	`nama_jamke` INT(11) NOT NULL,
...
-- Dumping structure for view moka.view_jadwal_x_pbs_sabtu
-- Creating temporary table to overcome VIEW dependency errors
CREATE TABLE `view_jadwal_x_pbs_sabtu` (
	`id_kbm` CHAR(5) NOT NULL COLLATE 'latin1_swedish_ci',
	`id_jadwal` INT(11) NOT NULL,
	`nama_hari` VARCHAR(50) NOT NULL COLLATE 'latin1_swedish_ci',
	`nama_jamke` INT(11) NOT NULL,
...
-- Dumping structure for view moka.view_jadwal_x_pbs_selasa
-- Creating temporary table to overcome VIEW dependency errors
CREATE TABLE `view_jadwal_x_pbs_selasa` (
	`id_kbm` CHAR(5) NOT NULL COLLATE 'latin1_swedish_ci',
	`id_jadwal` INT(11) NOT NULL,
	`nama_hari` VARCHAR(50) NOT NULL COLLATE 'latin1_swedish_ci',
	`nama_jamke` INT(11) NOT NULL,
...
-- Dumping structure for view moka.view_jadwal_x_pbs_senin
-- Creating temporary table to overcome VIEW dependency errors
CREATE TABLE `view_jadwal_x_pbs_senin` (
	`id_kbm` CHAR(5) NOT NULL COLLATE 'latin1_swedish_ci',
	`id_jadwal` INT(11) NOT NULL,
	`nama_hari` VARCHAR(50) NOT NULL COLLATE 'latin1_swedish_ci',
	`nama_jamke` INT(11) NOT NULL,
...
-- Dumping structure for view moka.view_jadwal_x_rpl_jumat
-- Creating temporary table to overcome VIEW dependency errors
CREATE TABLE `view_jadwal_x_rpl_jumat` (
	`id_kbm` CHAR(5) NOT NULL COLLATE 'latin1_swedish_ci',
	`id_jadwal` INT(11) NOT NULL,
	`nama_hari` VARCHAR(50) NOT NULL COLLATE 'latin1_swedish_ci',
	`nama_jamke` INT(11) NOT NULL,
...
-- Dumping structure for view moka.view_jadwal_x_rpl_kamis
-- Creating temporary table to overcome VIEW dependency errors
CREATE TABLE `view_jadwal_x_rpl_kamis` (
	`id_kbm` CHAR(5) NOT NULL COLLATE 'latin1_swedish_ci',
	`id_jadwal` INT(11) NOT NULL,
	`nama_hari` VARCHAR(50) NOT NULL COLLATE 'latin1_swedish_ci',
	`nama_jamke` INT(11) NOT NULL,
...
-- Dumping structure for view moka.view_jadwal_x_rpl_rabu
-- Creating temporary table to overcome VIEW dependency errors
CREATE TABLE `view_jadwal_x_rpl_rabu` (
	`id_kbm` CHAR(5) NOT NULL COLLATE 'latin1_swedish_ci',
	`id_jadwal` INT(11) NOT NULL,
	`nama_hari` VARCHAR(50) NOT NULL COLLATE 'latin1_swedish_ci',
	`nama_jamke` INT(11) NOT NULL,
...
-- Dumping structure for view moka.view_jadwal_x_rpl_sabtu
-- Creating temporary table to overcome VIEW dependency errors
CREATE TABLE `view_jadwal_x_rpl_sabtu` (
	`id_kbm` CHAR(5) NOT NULL COLLATE 'latin1_swedish_ci',
	`id_jadwal` INT(11) NOT NULL,
	`nama_hari` VARCHAR(50) NOT NULL COLLATE 'latin1_swedish_ci',
	`nama_jamke` INT(11) NOT NULL,
...
-- Dumping structure for view moka.view_jadwal_x_rpl_selasa
-- Creating temporary table to overcome VIEW dependency errors
CREATE TABLE `view_jadwal_x_rpl_selasa` (
	`id_kbm` CHAR(5) NOT NULL COLLATE 'latin1_swedish_ci',
	`id_jadwal` INT(11) NOT NULL,
	`nama_hari` VARCHAR(50) NOT NULL COLLATE 'latin1_swedish_ci',
	`nama_jamke` INT(11) NOT NULL,
...
-- Dumping structure for view moka.view_jadwal_x_rpl_senin
-- Creating temporary table to overcome VIEW dependency errors
CREATE TABLE `view_jadwal_x_rpl_senin` (
	`id_kbm` CHAR(5) NOT NULL COLLATE 'latin1_swedish_ci',
	`id_jadwal` INT(11) NOT NULL,
	`nama_hari` VARCHAR(50) NOT NULL COLLATE 'latin1_swedish_ci',
	`nama_jamke` INT(11) NOT NULL,
...
-- Dumping structure for view moka.view_presensi_siswa_tambah
-- Creating temporary table to overcome VIEW dependency errors
CREATE TABLE `view_presensi_siswa_tambah` (
...
-- Dumping structure for view moka.view_siswa_presensi_today_gtk020
-- Creating temporary table to overcome VIEW dependency errors
CREATE TABLE `view_siswa_presensi_today_gtk020` (
	`id_siswa` VARCHAR(10) NOT NULL COLLATE 'latin1_swedish_ci',
	`nama` VARCHAR(50) NOT NULL COLLATE 'latin1_swedish_ci',
	`foto` VARCHAR(50) NULL COLLATE 'latin1_swedish_ci',
	`id_mapel` INT(11) NOT NULL,
...
-- Dumping structure for view moka.view_id_mengajar_today
-- Removing temporary table and create final VIEW structure
DROP TABLE IF EXISTS `view_id_mengajar_today`;
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `view_id_mengajar_today` AS select jadwal_kbm.id_mengajar
from jadwal_kbm
...
-- Dumping structure for view moka.view_jadwal_xii_pbs_jumat
-- Removing temporary table and create final VIEW structure
DROP TABLE IF EXISTS `view_jadwal_xii_pbs_jumat`;
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `view_jadwal_xii_pbs_jumat` AS select
...
-- Dumping structure for view moka.view_jadwal_xii_pbs_kamis
-- Removing temporary table and create final VIEW structure
DROP TABLE IF EXISTS `view_jadwal_xii_pbs_kamis`;
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `view_jadwal_xii_pbs_kamis` AS select
jadwal_kbm.id_kbm,jadwal_kbm.id_jadwal,
hari.nama_hari,
jamke.nama_jamke,
mapel.nama_mapel,
...
-- Dumping structure for view moka.view_jadwal_xii_pbs_rabu
-- Removing temporary table and create final VIEW structure
DROP TABLE IF EXISTS `view_jadwal_xii_pbs_rabu`;
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `view_jadwal_xii_pbs_rabu` AS select
jadwal_kbm.id_kbm,jadwal_kbm.id_jadwal,
hari.nama_hari,
jamke.nama_jamke,
mapel.nama_mapel,
...
-- Dumping structure for view moka.view_jadwal_xii_pbs_sabtu
-- Removing temporary table and create final VIEW structure
DROP TABLE IF EXISTS `view_jadwal_xii_pbs_sabtu`;
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `view_jadwal_xii_pbs_sabtu` AS select
jadwal_kbm.id_kbm,jadwal_kbm.id_jadwal,
hari.nama_hari,
jamke.nama_jamke,
mapel.nama_mapel,
...
-- Dumping structure for view moka.view_jadwal_xii_pbs_selasa
-- Removing temporary table and create final VIEW structure
DROP TABLE IF EXISTS `view_jadwal_xii_pbs_selasa`;
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `view_jadwal_xii_pbs_selasa` AS select
jadwal_kbm.id_kbm,
...
-- Dumping structure for view moka.view_jadwal_xii_pbs_senin
-- Removing temporary table and create final VIEW structure
DROP TABLE IF EXISTS `view_jadwal_xii_pbs_senin`;
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `view_jadwal_xii_pbs_senin` AS select
jadwal_kbm.id_kbm,
jadwal_kbm.id_jadwal,
hari.nama_hari,
jamke.nama_jamke,
...
-- Dumping structure for view moka.view_jadwal_xii_rpl_jumat
-- Removing temporary table and create final VIEW structure
DROP TABLE IF EXISTS `view_jadwal_xii_rpl_jumat`;
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `view_jadwal_xii_rpl_jumat` AS select
jadwal_kbm.id_kbm,jadwal_kbm.id_jadwal,
hari.nama_hari,
jamke.nama_jamke,
mapel.nama_mapel,
...
-- Dumping structure for view moka.view_jadwal_xii_rpl_kamis
-- Removing temporary table and create final VIEW structure
DROP TABLE IF EXISTS `view_jadwal_xii_rpl_kamis`;
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `view_jadwal_xii_rpl_kamis` AS select
jadwal_kbm.id_kbm,jadwal_kbm.id_jadwal,
hari.nama_hari,
jamke.nama_jamke,
mapel.nama_mapel,
...
-- Dumping structure for view moka.view_jadwal_xii_rpl_rabu
-- Removing temporary table and create final VIEW structure
DROP TABLE IF EXISTS `view_jadwal_xii_rpl_rabu`;
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `view_jadwal_xii_rpl_rabu` AS select
jadwal_kbm.id_kbm,jadwal_kbm.id_jadwal,
hari.nama_hari,
jamke.nama_jamke,
mapel.nama_mapel,
...
-- Dumping structure for view moka.view_jadwal_xii_rpl_sabtu
-- Removing temporary table and create final VIEW structure
DROP TABLE IF EXISTS `view_jadwal_xii_rpl_sabtu`;
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `view_jadwal_xii_rpl_sabtu` AS select
jadwal_kbm.id_kbm,jadwal_kbm.id_jadwal,
hari.nama_hari,
jamke.nama_jamke,
mapel.nama_mapel,
...
-- Dumping structure for view moka.view_jadwal_xii_rpl_selasa
-- Removing temporary table and create final VIEW structure
DROP TABLE IF EXISTS `view_jadwal_xii_rpl_selasa`;
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `view_jadwal_xii_rpl_selasa` AS select
jadwal_kbm.id_kbm,jadwal_kbm.id_jadwal,
hari.nama_hari,
jamke.nama_jamke,
mapel.nama_mapel,
...
-- Dumping structure for view moka.view_jadwal_xii_rpl_senin
-- Removing temporary table and create final VIEW structure
DROP TABLE IF EXISTS `view_jadwal_xii_rpl_senin`;
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `view_jadwal_xii_rpl_senin` AS select
jadwal_kbm.id_kbm,jadwal_kbm.id_jadwal,
hari.nama_hari,
jamke.nama_jamke,
mapel.nama_mapel,
...
-- Dumping structure for view moka.view_jadwal_xi_pbs_jumat
-- Removing temporary table and create final VIEW structure
DROP TABLE IF EXISTS `view_jadwal_xi_pbs_jumat`;
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `view_jadwal_xi_pbs_jumat` AS select
jadwal_kbm.id_kbm,jadwal_kbm.id_jadwal,
hari.nama_hari,
jamke.nama_jamke,
mapel.nama_mapel,
...
-- Dumping structure for view moka.view_jadwal_xi_pbs_kamis
-- Removing temporary table and create final VIEW structure
DROP TABLE IF EXISTS `view_jadwal_xi_pbs_kamis`;
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `view_jadwal_xi_pbs_kamis` AS select
jadwal_kbm.id_kbm,jadwal_kbm.id_jadwal,
hari.nama_hari,
jamke.nama_jamke,
mapel.nama_mapel,
...
-- Dumping structure for view moka.view_jadwal_xi_pbs_rabu
-- Removing temporary table and create final VIEW structure
DROP TABLE IF EXISTS `view_jadwal_xi_pbs_rabu`;
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `view_jadwal_xi_pbs_rabu` AS select
jadwal_kbm.id_kbm,jadwal_kbm.id_jadwal,
hari.nama_hari,
jamke.nama_jamke,
mapel.nama_mapel,
...
-- Dumping structure for view moka.view_jadwal_xi_pbs_sabtu
-- Removing temporary table and create final VIEW structure
DROP TABLE IF EXISTS `view_jadwal_xi_pbs_sabtu`;
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `view_jadwal_xi_pbs_sabtu` AS select
jadwal_kbm.id_kbm,jadwal_kbm.id_jadwal,
hari.nama_hari,
jamke.nama_jamke,
mapel.nama_mapel,
...
-- Dumping structure for view moka.view_jadwal_xi_pbs_selasa
-- Removing temporary table and create final VIEW structure
DROP TABLE IF EXISTS `view_jadwal_xi_pbs_selasa`;
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `view_jadwal_xi_pbs_selasa` AS select
jadwal_kbm.id_kbm,jadwal_kbm.id_jadwal,
hari.nama_hari,
jamke.nama_jamke,
mapel.nama_mapel,
...
-- Dumping structure for view moka.view_jadwal_xi_pbs_senin
-- Removing temporary table and create final VIEW structure
DROP TABLE IF EXISTS `view_jadwal_xi_pbs_senin`;
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `view_jadwal_xi_pbs_senin` AS select
jadwal_kbm.id_kbm,jadwal_kbm.id_jadwal,
hari.nama_hari,
jamke.nama_jamke,
mapel.nama_mapel,
...
-- Dumping structure for view moka.view_jadwal_xi_rpl_jumat
-- Removing temporary table and create final VIEW structure
DROP TABLE IF EXISTS `view_jadwal_xi_rpl_jumat`;
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `view_jadwal_xi_rpl_jumat` AS select
jadwal_kbm.id_kbm,jadwal_kbm.id_jadwal,
hari.nama_hari,
jamke.nama_jamke,
mapel.nama_mapel,
...
-- Dumping structure for view moka.view_jadwal_xi_rpl_kamis
-- Removing temporary table and create final VIEW structure
DROP TABLE IF EXISTS `view_jadwal_xi_rpl_kamis`;
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `view_jadwal_xi_rpl_kamis` AS select
jadwal_kbm.id_kbm,jadwal_kbm.id_jadwal,
hari.nama_hari,
jamke.nama_jamke,
mapel.nama_mapel,
...
-- Dumping structure for view moka.view_jadwal_xi_rpl_rabu
-- Removing temporary table and create final VIEW structure
DROP TABLE IF EXISTS `view_jadwal_xi_rpl_rabu`;
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `view_jadwal_xi_rpl_rabu` AS select
jadwal_kbm.id_kbm,jadwal_kbm.id_jadwal,
hari.nama_hari,
jamke.nama_jamke,
mapel.nama_mapel,
...
-- Dumping structure for view moka.view_jadwal_xi_rpl_sabtu
-- Removing temporary table and create final VIEW structure
DROP TABLE IF EXISTS `view_jadwal_xi_rpl_sabtu`;
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `view_jadwal_xi_rpl_sabtu` AS select
jadwal_kbm.id_kbm,jadwal_kbm.id_jadwal,
hari.nama_hari,
jamke.nama_jamke,
mapel.nama_mapel,
...
-- Dumping structure for view moka.view_jadwal_xi_rpl_selasa
-- Removing temporary table and create final VIEW structure
DROP TABLE IF EXISTS `view_jadwal_xi_rpl_selasa`;
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `view_jadwal_xi_rpl_selasa` AS select
jadwal_kbm.id_kbm,
jadwal_kbm.id_jadwal,
hari.nama_hari,
jamke.nama_jamke,
...
-- Dumping structure for view moka.view_jadwal_xi_rpl_senin
-- Removing temporary table and create final VIEW structure
DROP TABLE IF EXISTS `view_jadwal_xi_rpl_senin`;
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `view_jadwal_xi_rpl_senin` AS SELECT
jadwal_kbm.id_kbm,
jadwal_kbm.id_jadwal,
hari.nama_hari,
jamke.nama_jamke,
...
-- Dumping structure for view moka.view_jadwal_x_pbs_jumat
-- Removing temporary table and create final VIEW structure
DROP TABLE IF EXISTS `view_jadwal_x_pbs_jumat`;
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `view_jadwal_x_pbs_jumat` AS select
jadwal_kbm.id_kbm,jadwal_kbm.id_jadwal,
hari.nama_hari,
jamke.nama_jamke,
mapel.nama_mapel,
...
-- Dumping structure for view moka.view_jadwal_x_pbs_kamis
-- Removing temporary table and create final VIEW structure
DROP TABLE IF EXISTS `view_jadwal_x_pbs_kamis`;
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `view_jadwal_x_pbs_kamis` AS select
jadwal_kbm.id_kbm,jadwal_kbm.id_jadwal,
hari.nama_hari,
jamke.nama_jamke,
mapel.nama_mapel,
...
-- Dumping structure for view moka.view_jadwal_x_pbs_rabu
-- Removing temporary table and create final VIEW structure
DROP TABLE IF EXISTS `view_jadwal_x_pbs_rabu`;
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `view_jadwal_x_pbs_rabu` AS select
jadwal_kbm.id_kbm,jadwal_kbm.id_jadwal,
hari.nama_hari,
jamke.nama_jamke,
mapel.nama_mapel,
...
-- Dumping structure for view moka.view_jadwal_x_pbs_sabtu
-- Removing temporary table and create final VIEW structure
DROP TABLE IF EXISTS `view_jadwal_x_pbs_sabtu`;
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `view_jadwal_x_pbs_sabtu` AS select
jadwal_kbm.id_kbm,jadwal_kbm.id_jadwal,
hari.nama_hari,
jamke.nama_jamke,
mapel.nama_mapel,
...
-- Dumping structure for view moka.view_jadwal_x_pbs_selasa
-- Removing temporary table and create final VIEW structure
DROP TABLE IF EXISTS `view_jadwal_x_pbs_selasa`;
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `view_jadwal_x_pbs_selasa` AS select
jadwal_kbm.id_kbm,jadwal_kbm.id_jadwal,
hari.nama_hari,
jamke.nama_jamke,
mapel.nama_mapel,
...
-- Dumping structure for view moka.view_jadwal_x_pbs_senin
-- Removing temporary table and create final VIEW structure
DROP TABLE IF EXISTS `view_jadwal_x_pbs_senin`;
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `view_jadwal_x_pbs_senin` AS select
jadwal_kbm.id_kbm,jadwal_kbm.id_jadwal,
hari.nama_hari,
jamke.nama_jamke,
mapel.nama_mapel,
...
-- Dumping structure for view moka.view_jadwal_x_rpl_jumat
-- Removing temporary table and create final VIEW structure
DROP TABLE IF EXISTS `view_jadwal_x_rpl_jumat`;
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `view_jadwal_x_rpl_jumat` AS select
jadwal_kbm.id_kbm,jadwal_kbm.id_jadwal,
hari.nama_hari,
jamke.nama_jamke,
mapel.nama_mapel,
...
-- Dumping structure for view moka.view_jadwal_x_rpl_kamis
-- Removing temporary table and create final VIEW structure
DROP TABLE IF EXISTS `view_jadwal_x_rpl_kamis`;
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `view_jadwal_x_rpl_kamis` AS select
jadwal_kbm.id_kbm,jadwal_kbm.id_jadwal,
hari.nama_hari,
jamke.nama_jamke,
mapel.nama_mapel,
...
-- Dumping structure for view moka.view_jadwal_x_rpl_rabu
-- Removing temporary table and create final VIEW structure
DROP TABLE IF EXISTS `view_jadwal_x_rpl_rabu`;
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `view_jadwal_x_rpl_rabu` AS select
jadwal_kbm.id_kbm,jadwal_kbm.id_jadwal,
hari.nama_hari,
jamke.nama_jamke,
mapel.nama_mapel,
...
-- Dumping structure for view moka.view_jadwal_x_rpl_sabtu
-- Removing temporary table and create final VIEW structure
DROP TABLE IF EXISTS `view_jadwal_x_rpl_sabtu`;
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `view_jadwal_x_rpl_sabtu` AS select
jadwal_kbm.id_kbm,jadwal_kbm.id_jadwal,
hari.nama_hari,
jamke.nama_jamke,
mapel.nama_mapel,
...
-- Dumping structure for view moka.view_jadwal_x_rpl_selasa
-- Removing temporary table and create final VIEW structure
DROP TABLE IF EXISTS `view_jadwal_x_rpl_selasa`;
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `view_jadwal_x_rpl_selasa` AS select
jadwal_kbm.id_kbm,jadwal_kbm.id_jadwal,
hari.nama_hari,
jamke.nama_jamke,
mapel.nama_mapel,
...
-- Dumping structure for view moka.view_jadwal_x_rpl_senin
-- Removing temporary table and create final VIEW structure
DROP TABLE IF EXISTS `view_jadwal_x_rpl_senin`;
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `view_jadwal_x_rpl_senin` AS select
jadwal_kbm.id_kbm,jadwal_kbm.id_jadwal,
hari.nama_hari,
jamke.nama_jamke,
mapel.nama_mapel,
...
-- Dumping structure for view moka.view_presensi_siswa_tambah
-- Removing temporary table and create final VIEW structure
DROP TABLE IF EXISTS `view_presensi_siswa_tambah`;
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `view_presensi_siswa_tambah` AS SELECT 
siswa.id_siswa,
siswa.nama,
siswa.nis,
siswa.foto,
...
-- Dumping structure for view moka.view_siswa_presensi_today_gtk020
-- Removing temporary table and create final VIEW structure
DROP TABLE IF EXISTS `view_siswa_presensi_today_gtk020`;
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `view_siswa_presensi_today_gtk020` AS SELECT 
siswa.id_siswa,
siswa.nama,
siswa.foto,
mapel.id_mapel,
