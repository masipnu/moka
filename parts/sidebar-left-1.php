  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li><a href="?hal=identitas-sekolah-view"><i class="fa fa-building"></i> <span>Profil Sekolah</span></a></li>
        ...
        <li class="treeview">
          <a href="#"><i class="fa fa-envelope-o"></i> <span>Saran & Masukan</span>
            <span class="pull-right-container">
                <i class="fa fa-angle-left pull-right"></i>
              </span>
          </a>
          <ul class="treeview-menu">
            <li><a href="#"><i class="fa fa-sticky-note-o"></i> Saran Siswa</a></li>
            <li><a href="#"><i class="fa fa-sticky-note-o"></i> Saran Orang Tua</a></li>
          </ul>
        </li>

        <li class="treeview">
          <a href="#"><i class="fa fa-user-secret"></i> <span>User Management</span>
            <span class="pull-right-container">
                <i class="fa fa-angle-left pull-right"></i>
              </span>
          </a>
          <ul class="treeview-menu">
            <li><a href="#"><i class="fa fa-gears"></i> Role</a></li>
