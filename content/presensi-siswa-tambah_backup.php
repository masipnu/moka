  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <form role="form" method="post" action="?hal=presensi-siswa-test">
      <input type="text" name="tanggal" value="<?= date('m/d/Y'); ?>" hidden>
              ...
              <ul class="nav nav-stacked">
                <li>
                  ...
                  <div class="radio text-center">
                    <label class="col-3">
                      <input type="radio" name="presensi<?= $data['id_siswa'] ?>s"  value="1">Hadir
                    </label>
                    <label class="col-3">
                      <input type="radio" name="presensi<?= $data['id_siswa'] ?>s"  value="2">Izin
                    </label>
                    <label class="col-3">
                      <input type="radio" name="presensi<?= $data['id_siswa'] ?>s"  value="3">Sakit
                    </label>
                    <label class="col-3">
                      <input type="radio" name="presensi<?= $data['id_siswa'] ?>s"  value="4">Tanpa Keterangan
                    </label>
                  </div>
                </li>
                <li>
