      ...
      <div class="tab-pane active" id="xirpl_senin">
        ...
        <div class="box-body table-responsive no-padding">
          <table class="table table-hover">
            ...
            <?php
            $query = mysqli_query($con, "SELECT * FROM view_jadwal_xi_rpl_senin");
            $no = 0;
    ...
    <div class="tab-pane" id="xirpl_selasa">
      <div class="box-body table-responsive no-padding">
        <table class="table table-hover">
          ...
          <?php
          $query = mysqli_query($con, "SELECT * FROM view_jadwal_xi_rpl_selasa");
          $no = 0;
          while($data = mysqli_fetch_array($query)){
            $no++;
            ?>
  ...
  <div class="tab-pane" id="xirpl_rabu">
    <div class="box-body table-responsive no-padding">
      <table class="table table-hover">
        ...
        <?php
        $query = mysqli_query($con, "SELECT * FROM view_jadwal_xi_rpl_rabu");
        $no = 0;
        while($data = mysqli_fetch_array($query)){
          $no++;
          ?>
...
<div class="tab-pane" id="xirpl_kamis">
  <div class="box-body table-responsive no-padding">
    <table class="table table-hover">
      ...
      <?php
      $query = mysqli_query($con, "SELECT * FROM view_jadwal_xi_rpl_kamis");
      $no = 0;
      while($data = mysqli_fetch_array($query)){
        $no++;
        ?>
...
<div class="tab-pane" id="xirpl_jumat">
  <div class="box-body table-responsive no-padding">
    <table class="table table-hover">
      ...
      <?php
      $query = mysqli_query($con, "SELECT * FROM view_jadwal_xi_rpl_jumat");
      $no = 0;
      while($data = mysqli_fetch_array($query)){
        $no++;
        ?>
...
<div class="tab-pane" id="xirpl_sabtu">
  <div class="box-body table-responsive no-padding">
    <table class="table table-hover">
      ...
      <?php
      $query = mysqli_query($con, "SELECT * FROM view_jadwal_xi_rpl_sabtu");
      $no = 0;
      while($data = mysqli_fetch_array($query)){
        $no++;
        ?>
