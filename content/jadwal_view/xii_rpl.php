      ...
      <div class="tab-pane active" id="xiirpl_senin">
        ...
        <div class="box-body table-responsive no-padding">
          <table class="table table-hover">
            ...
            <?php
            $query = mysqli_query($con, "SELECT * FROM view_jadwal_xii_rpl_senin");
            $no = 0;
    ...
    <div class="tab-pane" id="xiirpl_selasa">
      <div class="box-body table-responsive no-padding">
        <table class="table table-hover">
          ...
          <?php
          $query = mysqli_query($con, "SELECT * FROM view_jadwal_xii_rpl_selasa");
          $no = 0;
          while($data = mysqli_fetch_array($query)){
            $no++;
            ?>
  ...
  <div class="tab-pane" id="xiirpl_rabu">
    <div class="box-body table-responsive no-padding">
      <table class="table table-hover">
        ...
        <?php
        $query = mysqli_query($con, "SELECT * FROM view_jadwal_xii_rpl_rabu");
        $no = 0;
        while($data = mysqli_fetch_array($query)){
          $no++;
          ?>
...
<div class="tab-pane" id="xiirpl_kamis">
  <div class="box-body table-responsive no-padding">
    <table class="table table-hover">
      ...
      <?php
      $query = mysqli_query($con, "SELECT * FROM view_jadwal_xii_rpl_kamis");
      $no = 0;
      while($data = mysqli_fetch_array($query)){
        $no++;
        ?>
...
<div class="tab-pane" id="xiirpl_jumat">
  <div class="box-body table-responsive no-padding">
    <table class="table table-hover">
      ...
      <?php
      $query = mysqli_query($con, "SELECT * FROM view_jadwal_xii_rpl_jumat");
      $no = 0;
      while($data = mysqli_fetch_array($query)){
        $no++;
        ?>
...
<div class="tab-pane" id="xiirpl_sabtu">
  <div class="box-body table-responsive no-padding">
    <table class="table table-hover">
      ...
      <?php
      $query = mysqli_query($con, "SELECT * FROM view_jadwal_xii_rpl_sabtu");
      $no = 0;
      while($data = mysqli_fetch_array($query)){
        $no++;
        ?>
