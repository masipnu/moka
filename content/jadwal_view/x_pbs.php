      ...
      <div class="tab-pane active" id="xpbs_senin">
        ...
        <div class="box-body table-responsive no-padding">
          <table class="table table-hover">
            ...
            <?php
            $query = mysqli_query($con, "SELECT * FROM view_jadwal_x_pbs_senin");
            $no = 0;
    ...
    <div class="tab-pane" id="xpbs_selasa">
      <div class="box-body table-responsive no-padding">
        <table class="table table-hover">
          ...
          <?php
          $query = mysqli_query($con, "SELECT * FROM view_jadwal_x_pbs_selasa");
          $no = 0;
          while($data = mysqli_fetch_array($query)){
            $no++;
            ?>
  ...
  <div class="tab-pane" id="xpbs_rabu">
    <div class="box-body table-responsive no-padding">
      <table class="table table-hover">
        ...
        <?php
        $query = mysqli_query($con, "SELECT * FROM view_jadwal_x_pbs_rabu");
        $no = 0;
        while($data = mysqli_fetch_array($query)){
          $no++;
          ?>
...
<div class="tab-pane" id="xpbs_kamis">
  <div class="box-body table-responsive no-padding">
    <table class="table table-hover">
      ...
      <?php
      $query = mysqli_query($con, "SELECT * FROM view_jadwal_x_pbs_kamis");
      $no = 0;
      while($data = mysqli_fetch_array($query)){
        $no++;
        ?>
...
<div class="tab-pane" id="xpbs_jumat">
  <div class="box-body table-responsive no-padding">
    <table class="table table-hover">
      ...
      <?php
      $query = mysqli_query($con, "SELECT * FROM view_jadwal_x_pbs_jumat");
      $no = 0;
      while($data = mysqli_fetch_array($query)){
        $no++;
        ?>
...
<div class="tab-pane" id="xpbs_sabtu">
  <div class="box-body table-responsive no-padding">
    <table class="table table-hover">
      ...
      <?php
      $query = mysqli_query($con, "SELECT * FROM view_jadwal_x_pbs_sabtu");
      $no = 0;
      while($data = mysqli_fetch_array($query)){
        $no++;
        ?>
