      ...
      <div class="tab-pane active" id="xipbs_senin">
        ...
        <div class="box-body table-responsive no-padding">
          <table class="table table-hover">
            ...
            <?php
            $query = mysqli_query($con, "SELECT * FROM view_jadwal_xi_pbs_senin");
            $no = 0;
    ...
    <div class="tab-pane" id="xipbs_selasa">
      <div class="box-body table-responsive no-padding">
        <table class="table table-hover">
          ...
          <?php
          $query = mysqli_query($con, "SELECT * FROM view_jadwal_xi_pbs_selasa");
          $no = 0;
          while($data = mysqli_fetch_array($query)){
            $no++;
            ?>
  ...
  <div class="tab-pane" id="xipbs_rabu">
    <div class="box-body table-responsive no-padding">
      <table class="table table-hover">
        ...
        <?php
        $query = mysqli_query($con, "SELECT * FROM view_jadwal_xi_pbs_rabu");
        $no = 0;
        while($data = mysqli_fetch_array($query)){
          $no++;
          ?>
...
<div class="tab-pane" id="xipbs_kamis">
  <div class="box-body table-responsive no-padding">
    <table class="table table-hover">
      ...
      <?php
      $query = mysqli_query($con, "SELECT * FROM view_jadwal_xi_pbs_kamis");
      $no = 0;
      while($data = mysqli_fetch_array($query)){
        $no++;
        ?>
...
<div class="tab-pane" id="xipbs_jumat">
  <div class="box-body table-responsive no-padding">
    <table class="table table-hover">
      ...
      <?php
      $query = mysqli_query($con, "SELECT * FROM view_jadwal_xi_pbs_jumat");
      $no = 0;
      while($data = mysqli_fetch_array($query)){
        $no++;
        ?>
...
<div class="tab-pane" id="xipbs_sabtu">
  <div class="box-body table-responsive no-padding">
    <table class="table table-hover">
      ...
      <?php
      $query = mysqli_query($con, "SELECT * FROM view_jadwal_xi_pbs_sabtu");
      $no = 0;
      while($data = mysqli_fetch_array($query)){
        $no++;
        ?>
